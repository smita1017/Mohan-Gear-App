...
const Productsection = () => {
  return (
    <div className='flex items-center justify-end w-full h-70 bg-no-repeat bg-cover bg-center md:p-20 ' style={{
        ...
        <h1 className='text-3xl font-bold text-red-500 text-center'>Why Mukund Trans-gear? </h1>
        <p className='font-Kdam Thmor Pro text-lg leading-relaxed tracking-wide
'>Precision-engineered gears
        with <span className='text-red-500 text-xl font-bold'>20+years</span> of expertise, strict quality control, and superior durability.</p>
    </div>
    </div>
  )
}
