  ...
  return (
    <section className='flex flex-col items-center justify-center w-full bg-white gap-6 mt-2'>
      <div className='flex flex-col items-center justify-center w-full p-4 gap-4'>
        <h1 style={{"fontFamily":"judson"}} className='text-[#39615F] text-3xl md:text-4xl font-semibold mb-4'>Our Products</h1>
        <p style={{"fontFamily":"inter"}}  className='text-center mb-2'>
          <span style={{"fontFamily":"judson"}} className='text-[#39615F] text-lg'>Mukund Trans-Gears</span> specializes in manufacturing, exporting, and supplying high-quality industrial equipment, including:
        </p>
        ...
        <p style={{"fontFamily":"inter"}} className='text-justify w-full md:w-[885px] mb-5'>
