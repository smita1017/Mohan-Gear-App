...
const Form1 = () => {
  return (
    <div className="w-full bg-[#B6C6C8] p-1 md:p-15 flex flex-col sm:flex-row items-stretch justify-center font-judson">
  ...
  <button
    type="submit"
    className="mt-4 bg-[#39615F] text-white py-2 px-4 rounded-md hover:bg-[#2e4e4c] w-fit self-center"
  >
    Submit
  </button>
</form>
